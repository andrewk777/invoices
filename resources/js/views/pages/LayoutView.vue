...
onBeforeMount(async () => {
  // await import('@assets/vendor/libs/jquery/jquery.js');
  // await import('@assets/vendor/libs/popper/popper.js');
  // await import('@assets/vendor/js/bootstrap.js');
  await import('@assets/vendor/libs/node-waves/node-waves.js');
  await import('@assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js');
  await import('@assets/vendor/libs/hammer/hammer.js');
  await import('@assets/vendor/libs/i18n/i18n.js');
  await import('@assets/vendor/libs/typeahead-js/typeahead.js');
  await import('@assets/vendor/js/menu.js');
  await import('@assets/vendor/libs/apex-charts/apexcharts.js');
  await import('@assets/vendor/libs/swiper/swiper.js');
  await import('@assets/vendor/libs/datatables-bs5/datatables-bootstrap5.js');
  await import('@assets/js/main.js');
  // await import('@assets/js/dashboards-analytics.js');
});
...
// Menu dropdown
let dropdowns = document.querySelectorAll(".menu-item");
        ...
        <ul class="menu-inner py-1 mt-2">
          ...
          <li class="menu-item">
            <router-link
              ...
              <i class="fa-solid fa-file-invoice fa-2x mr-2"></i>
          ...
          <li class="menu-item">
            <router-link
              ...
              <i class="menu-icon fa fa-wallet fa-2x"></i>
              <div data-i18n="Dashboards">Subscriptions</div>
            </router-link>
          </li>
...
<!--          </li>-->
          ...
          <li class="menu-item has-dropdown">
            <router-link
              ...
              to="">
              <i class="menu-icon fa fa-user fa-2x"></i>
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="" class="menu-link">
                  <div data-i18n="Collapsed menu">Users</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="" class="menu-link">
      ...
      <div class="layout-page">
        ...
        <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme" id="layout-navbar">
          ...
          <div class="layout-menu-toggle navbar-nav align-items-xl-center me-3 me-xl-0   d-xl-none ">
            <a class="nav-item nav-link px-0 me-xl-4" @click.prevent="toggleMenu">
...
<!--                  <a href="https://pixinvent.ticksy.com/" target="_blank" class="footer-link d-none d-sm-inline-block">Support</a>-->
    ...
    <!-- Overlay -->
    <div class="layout-overlay layout-menu-toggle" @click.prevent="toggleMenu"></div>
